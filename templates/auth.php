    ...
    <div class="container container--with-sidebar">
        ...
        <div class="content">
            ...
            <main class="content__main">
                ...
                <form class="form" action="/user-auth.php" method="post" autocomplete="off">
                    <div class="form__row">
                        <label class="form__label" for="email">E-mail <sup>*</sup></label>

                        <input class="form__input <?= isset($error['email']) ? ' form__input--error' : '' ?>" type="text"
                               name="email" id="email" value="<?php echo isset($_POST['email'])? strip_tags($_POST['email']): '' ?>" placeholder="Введите e-mail">
                    ...
                    <div class="form__row">
                        ...
                        <input class="form__input <?= isset($error['password']) ? ' form__input--error' : '' ?>" type="password"
